...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username && $email && $password && $firstName && $lastName) {
        ...
        if ($check->fetch()) {
            ...
            $stmt = $pdo->prepare("INSERT INTO users (username, email, password, first_name, last_name, role) VALUES (?, ?, ?, ?, ?, 'doctor')");
    ...
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-body p-4">
                <h4 class="mb-4"><i class="bi bi-person-plus"></i> Add New Doctor</h4>
                <?php if ($success): ?>
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="specialization" class="form-control" placeholder="e.g., Internal Medicine">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <button type="submit" class="btn btn-success w-100"><i class="bi bi-person-plus"></i> Add Doctor</button>
                </form>
                <div class="mt-3">
